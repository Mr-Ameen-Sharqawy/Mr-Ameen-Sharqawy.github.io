...
function GradeHome({ onSelect, studentUsername, allowedGrades, onSignOut }: { onSelect: (grade: Grade) => void; studentUsername: string; allowedGrades: Grade[]; onSignOut: () => void }) {
...
type SessionState = { status: "loading" } | { status: "signed-out" } | { status: "blocked"; message: string } | { status: "ready"; email: string; access: StudentAccess };
